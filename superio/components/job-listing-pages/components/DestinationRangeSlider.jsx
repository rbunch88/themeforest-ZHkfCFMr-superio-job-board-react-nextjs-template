...
const DestinationRangeSlider = () => {
    ...
    const [values, setValues] = useState([jobList.destination.min, jobList.destination.max]);
    ...
    useEffect(() => {
        ...
        setValues([jobList.destination.min, jobList.destination.max]);
    }, [jobList.destination.min, jobList.destination.max]); // Depend on specific min/max
