  ...
  return (
    ...
    <div style={{ height: '300px', width: '100%' }}>
      <GoogleMapReact
        ...
        bootstrapURLKeys={{ key: process.env.NEXT_PUBLIC_GOOGLE_MAPS_API_KEY }} // Use env variable
        // Use fetched coords when available, otherwise default
        center={coords || defaultProps.center}
        // defaultCenter={defaultProps.center} // Use dynamic center
